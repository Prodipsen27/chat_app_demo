...
public class Server implements ActionListener{
   ...
   static DataOutputStream dout;
    Server(){//Constructor for frame
        ...
        p1.setBackground(new Color(45,45,48));
        ...
        video.setBackground(new Color(45,45,48));
        p1.add(video);
        ...
        phone.setBackground(new Color(45,45,48));
        p1.add(phone);
        ...
        morevert.setBackground(new Color(45,45,48));
        p1.add(morevert);

        JLabel name = new JLabel("Bully Maguire");
